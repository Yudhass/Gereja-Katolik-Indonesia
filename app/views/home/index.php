...
<style>
    ...
    .gereja-card .card-body { padding: 1rem 1rem 0.85rem; }
    .gereja-card .card-title { font-weight: 700; font-size: 1.05rem; color: #2C4463; margin-bottom: 0.5rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
    .gereja-card .card-text { font-size: 0.85rem; color: #444; }
    .gereja-card .card-text .bx { flex-shrink: 0; }
    .gereja-card .btn-detail { background: var(--primary); color: white; border-radius: 50px; padding: 0.4rem 1rem; font-size: 0.82rem; border: none; font-weight: 600; transition: background .2s, transform .15s; }
    .gereja-card .btn-detail:hover { background: var(--primary-dark); transform: scale(1.02); }
    .gereja-card .btn-detail:active { transform: scale(0.97); }
    .lokasi-badge { background: rgba(0,0,0,0.05); color: #555; padding: 0.2rem 0.6rem; border-radius: 50px; font-size: 0.72rem; display: inline-flex; align-items: center; gap: 0.2rem; font-weight: 500; white-space: nowrap; }
    ...
    @media (max-width: 767px) {
        ...
        .gereja-card .card-title { font-size: 1.1rem; }
        .gereja-card .card-text { font-size: 0.92rem; }
        .gereja-card .btn-detail { font-size: 0.9rem; padding: 0.45rem 1rem; }
        ...
        <div class="col-12 col-md-4 col-xl-3">
            <div class="card gereja-card">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="<?= BASEURL; ?>gereja/<?= htmlspecialchars($g->slug ? $g->slug : $g->id); ?>" class="btn btn-detail w-100 mt-auto">
